...
const pricingPlans = [
  {
    ...
    features: ['Create up to 2 resumes', 'Access to basic templates', 'PDF downloads', 'Email support'],
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Choose the perfect plan for your resume building needs. All plans include our core features to help you
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {pricingPlans.map((plan, index) => (
          <Card
            key={index}
            className={`overflow-hidden flex flex-col ${plan.popular ? 'border-resume-primary shadow-lg relative' : ''}`}
          >
            {plan.popular && (

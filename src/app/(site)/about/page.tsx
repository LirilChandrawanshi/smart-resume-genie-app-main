...
const highlights = [
  {
    ...
    description:
      'Multiple layouts so you can match your industry and personality without starting from scratch.',
  },
  {
    icon: Sparkles,
  ...
  },
  {
    ...
    title: 'Fast workflow',
    description:
      'Edit in the browser, preview live, and save your work when you sign in—no desktop software required.',
  },
];
      ...
      <section className="relative border-b bg-gradient-to-b from-resume-accent/40 via-background to-background dark:from-resume-dark/30 dark:via-background">
        ...
        <div className="container relative mx-auto px-4 py-16 md:py-24">
          <div className="mx-auto max-w-3xl text-center animate-fade-in">
            <Badge
              variant="secondary"
              className="mb-4 border-resume-primary/20 bg-resume-primary/10 text-resume-primary dark:bg-resume-primary/20"
            >
              About ResumeGenie
            </Badge>
            <h1 className="mb-4 text-4xl font-bold tracking-tight text-foreground md:text-5xl">Resumes that open doors</h1>
            <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground md:text-xl">
              The smart way to build a professional resume—templates, live preview, and AI hints so you can apply with
              confidence.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <p>
                Job hunting is hard enough. Your resume should work for you: clear sections, strong wording, and a layout
                that reads well on paper and on screen. That is the experience we keep refining.
              </p>
            </div>
          </div>
            ...
            <CardContent className="p-0">
              <div className="grid md:grid-cols-[minmax(0,280px)_1fr]">
                ...
                <div className="p-8 md:p-10">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      Liril is a full-stack developer focused on React, Spring Boot, and practical uses of AI. He cares
                      about UX detail and performance so the product feels fast and trustworthy.
                    </p>
                    <p>
                      Away from the keyboard, he enjoys hiking, science fiction, and open source. The goal is simple: make
                      technology more accessible and help people present their best professional selves.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Everyone deserves tools that help them tell their career story clearly. We want to level the playing field
              with accessible, high-quality resume building—backed by modern tech and shaped by feedback from real
              users.
            </p>

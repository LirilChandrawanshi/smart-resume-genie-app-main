                  ...
                  {exp.description && (
                    <ul style={{ paddingLeft: '14px', margin: 0 }}>
                      {toLines(exp.description).map((l, j) => (
                        <li key={j} style={{ fontSize: '10px', color: '#374151', marginBottom: '2px', listStyleType: 'disc' }}>{l}</li>
                      ))}
                    </ul>
                  )}
                </div>
                  ...
                  {proj.description && (
                    <ul style={{ paddingLeft: '14px', margin: '3px 0 0' }}>
                      {toLines(proj.description).map((l, j) => (
                        <li key={j} style={{ fontSize: '10px', color: '#374151', marginBottom: '1px', listStyleType: 'disc' }}>{l}</li>
                      ))}
                    </ul>
                  )}
                </div>
